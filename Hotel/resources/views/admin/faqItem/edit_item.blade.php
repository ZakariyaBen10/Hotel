...
<form action="{{url('changing_item', $data->id)}}" method="POST" enctype="multipart/form-data">

@csrf

            <div style="padding:10px">
                <label for="">Category</label>
                <select name="faq_categories_id" required="" value="">
...
<option value="{{ $category->id }}" {{ $data->faq_categories_id == $category->id ? 'selected' : '' }}>
            ...
            <div style="padding:10px">
                ...
                <input type="text" name="answer" required="" value="{{$data->answer}}">
            </div>
